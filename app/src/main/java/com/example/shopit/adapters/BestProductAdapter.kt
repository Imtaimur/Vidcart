...
class BestProductAdapter: RecyclerView.Adapter<BestProductAdapter.BestProductViewHolder>() {
    ...
    private val diifcallBack=object :DiffUtil.ItemCallback<Product>(){
    ...
    val differ=AsyncListDiffer(this,diifcallBack)
    ...
    override fun onBindViewHolder(holder: BestProductAdapter.BestProductViewHolder, position: Int) {
